...
const int KNOB_PIN = 0; // set the base frequency to analog pin 0
const int LDR2_PIN=1; // set the analog input for fm_intensity to pin 1
const int LDR1_PIN=2; // set the analog input for mod rate to pin 2
const char INPUT_PIN=3; // set the volume to analog pin 3
...
int mod_ratio = 10; // brightness (harmonics)
...
void updateControl(){
  ...
  int LDR1_value= 1023 - mozziAnalogRead(LDR1_PIN); // value is 0-1023; 1023 - .... because reverse direction.
  // print the value to the Serial monitor for debugging
  Serial.print("LDR1 = ");
  Serial.print(LDR1_value);
  Serial.print("\t"); // prints a tab

  int LDR1_calibrated = 1.3*kMapIntensity(LDR1_value);
 ...
 // calculate the fm_intensity
  ...
  int LDR2_value= 1023 - mozziAnalogRead(LDR2_PIN); // value is 0-1023. 1023 - .... because reverse direction.
  Serial.print("LDR2 = ");
